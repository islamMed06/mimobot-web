...
export default function AdminLessons() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold mb-6">Leçons</h1>

      <form onSubmit={handleUpload} className="bg-white border border-gray-200 rounded-xl p-5 mb-8 space-y-3">
        <h2 className="font-semibold text-sm mb-2">Ajouter une leçon</h2>
      ...
      {!loading && lessons.length === 0 && <p className="text-gray-400 text-center py-8">Aucune leçon.</p>}
